  ...
  <div>
    <Paper style={style}>
      <Menu desktop={true} width={256}>
        ...
        <MenuItem primaryText="Strikethrough" secondaryText="Alt+Shift+6" />
        ...
        <MenuItem primaryText="Line spacing" secondaryText="&#8984;" rightIcon={<ArrowDropRight />}  leftIcon={<ArrowDropRight />} />
