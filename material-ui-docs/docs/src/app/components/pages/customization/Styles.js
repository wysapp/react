...
import stylesOverridingCssText from './styles-overriding-css.md';
...
import stylesOverridingCssExampleCode from '!raw!./StylesOverridingCssExample';

const stylesOverridingCssExampleCodeWithCss = `${stylesOverridingCssExampleCode}
/*
...
const Styles = () => (
  <div>
    ...
    <MarkdownElement text={stylesOverridingCssText} />
    <CodeExample 
      title="CSS Style example"
      code={stylesOverridingCssExampleCodeWithCss}
      component={false}
    >
