...
class Slider extends Component {
  static propTypes = {
    ...
    description: deprecated(PropTypes.node, 'Use a sibling node element instead. It will be remove with v0.17.0.'),
    disableFocusRipple: PropTypes.bool,
    disabled: PropTypes.bool,

    error: deprecated(PropTypes.node, 'Use a slibling node element instead. It will be removed with v0.17.0.'),
  ...
  render() {
    ...
    if (percent === 0) {
      handleStyles = Object.assign({},
        ...
        (hovered || focused) && !disabled && styles.handleWhenPercentZeroAndFocused,
    ...
    return (
      <div {...other} style={prepareStyles(Object.assign({}, style))}>
        ...
        <input type="hidden" name={name} value={value} required={required} min={min} max={max} step={step} />
      </div>
    );
  }
}
